...
// Agrupa notificações, alterar senha e sair num único menu — antes esses
// três apareciam soltos no cabeçalho e bagunçavam a tela no celular.
export default function TrainerAccountMenu() {
